  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Label17(text: "Demande #${detail!.reference}", color: GlobalThemeData.lightColorScheme.tertiary, weight: FontWeight.bold, maxLines: 1).animate().fadeIn(),
          const Gap(10),
          Label13(text: "Effectuée le ${DateFormat.yMMMMEEEEd("fr").format(detail!.dateDemande)} à ${DateFormat.Hm("fr").format(detail!.dateDemande)}", color: GlobalThemeData.lightColorScheme.onSurface, weight: FontWeight.normal, maxLines: 2).animate().fadeIn(),
          const Gap(20),
          Divider(
            color: GlobalThemeData.lightColorScheme.surfaceDim,
            thickness: 1,
            height: 1,
          ).animate().fadeIn(),
          const Gap(20),
