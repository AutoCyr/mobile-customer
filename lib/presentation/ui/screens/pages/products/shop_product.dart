...
class ShopProductScreen extends StatefulWidget {
  ...
  const ShopProductScreen({super.key, required this.partenaire});
...
class _ShopProductScreenState extends State<ShopProductScreen> {
  ...
  Map<String, dynamic> getParams(int view) {
    Map<String, dynamic> params = {
      "page": view,
      "limit": 50,
      "partenaire_id": widget.partenaire.partenaireId
    };
    return params;
  }
  ...
  retrievePieces(int view, bool more) async {
    ...
    await customer.retrieveShopPieces(context: context, params: params, more: more);
    searchedPieces = filteredPieces = pieces = customer.partnerPieces;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: _search == false ?
          Label14(text: "Articles de ${widget.partenaire.raisonSociale}", color: GlobalThemeData.lightColorScheme.tertiary, weight: FontWeight.bold, maxLines: 1).animate().fadeIn()
            :
          SizedBox(
            height: 45,
            child: TextFormField(
      ...
      body: Consumer<CustomerNotifier>(
        builder: (context, customer, child) {
          ...
          return RefreshLoadmore(
              ...
              isLastPage: customer.partnerPieceMeta.currentPage < customer.partnerPieceMeta.lastPage ? false : true,
