...
class CustomerDataSourceImpl implements CustomerDataSource {
  ...
  Future getShopPieces(Map<String, dynamic> params) async {
    ...
    try {
      final response = await _apiClient.getWithParams(path: "customer/shop-pieces", params: params, headers: headers);
  ...
  Future getRequests(Map<String, dynamic> params) async {
    ...
    try {
      final response = await _apiClient.getWithParams(path: "customer/get-demandes", params: params, headers: headers);
  ...
  Future getRequest(Map<String, dynamic> params) async {
    ...
    try {
      final response = await _apiClient.getWithParams(path: "customer/get-demande", params: params, headers: headers);
